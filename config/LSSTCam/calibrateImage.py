...
# Removed for v30: matcher/astrometry are no longer registered
# star selectors for MeasurePsfTask.
# config.psf_measure_psf.starSelector['matcher'].minSnr = 5.0
# config.psf_measure_psf.starSelector['astrometry'].minSnr = 5.0

# Removed for v30 for the same reason.
# config.psf_measure_psf.starSelector['matcher'].excludePixelFlags = False


# Use the VISTA Monster catalogue for both astrometry and photometry.
config.connections.astrometry_ref_cat = "the_monster_20250219_vista"
config.connections.photometry_ref_cat = "the_monster_20250219_vista"
...
config.photometry.photoCatName = "the_monster_20250219_vista"
