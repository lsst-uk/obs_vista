'''
Override the default calibrate config parameters. This is mainly
concerned with setting the reference catalogue and colour terms for
its use.
'''
...
# number of iterations of fitter (which fits X and Y separately, and
# so benefitqs from a few iterations
