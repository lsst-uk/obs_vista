...
class VircamMapper(CameraMapper):
    ...
    def __init__(self, inputPolicy=None, **kwargs):
        ...
        policyFile = Policy.defaultPolicyFile(
            self.packageName, "VircamMapper.yaml", "policy")
        policy = Policy(policyFile)
        # ...and add it to the mapper:
        super(VircamMapper, self).__init__(policy, os.path.dirname(policyFile), **kwargs)
    ...
    def _extractDetectorName(self, dataId):
        ...
        try:
            return VircamMapper.detectorNames[copyId['ccdnum']]
        except KeyError:
    ...
    def bypass_deepCoaddId_bits(self, *args, **kwargs):
        ...
        return 64 - VircamMapper._nbit_id  # 10+6+6 #Set large to avoid 'Exposure ID '34910216' is too large.
