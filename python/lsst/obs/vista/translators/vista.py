...
class VistaTranslator(FitsTranslator):
    ...
    def can_translate(cls, header, filename=None):
        ...
        contains "VISTA". However, you can make this as stringent as you like (e.g., 
    ...
    def to_physical_filter(self):
        ...
        if self.is_key_ok("FILTER"):
            value = 'VISTA-{}'.format(self._header["FILTER"].strip())
            self._used_these_cards("FILTER")
            return value
        elif self.is_key_ok("FLATCOR"):
            value = 'VISTA-{}'.format(self._header["FLATCOR"].split('_')[0])
