...
from lsst.obs.base import MakeRawVisitInfoViaObsInfo #MakeRawVisitInfo #deprecated
...
#         statement.
# 
#         However, it's recommended that you at least include the exposure time from the 
