...
"""Gen3 Butler Formatters for Vista confidence data.
"""
...
__all__ = ("VircamConfidenceFormatter",)
...
class VircamConfidenceFormatter(FitsRawFormatterBase):
    """Gen 3 Butler Formatters for VIRCAM confidence data.
